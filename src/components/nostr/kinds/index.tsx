...
import { Kind30142Renderer } from "./EducationalResourceRenderer";
import { Kind30142DetailRenderer } from "./EducationalResourceDetailRenderer";
...
const kindRenderers: Record<number, React.ComponentType<BaseEventProps>> = {
  ...
  30142: Kind30142Renderer, // Educational Resource (AMB)
...
> = {
  ...
  30142: Kind30142DetailRenderer, // Educational Resource Detail (AMB)
